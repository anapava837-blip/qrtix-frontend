          ...
          {isAuthenticated && user ? (
            <>
              <Link href='/members/account'>
                <ProfilePhoto image={user.photo} size='small' />
              </Link>
              <button
                type='button'
            ...
            <>
              <Link href='/members/signin' className='button gray-overlay button-sm'>
                <span className='material-symbols-outlined left-icon'>login</span>
                Iniciar sesi&oacute;n
              </Link>
              <Link href='/members/signup' className='button blue-filled button-sm'>
                <span className='material-symbols-outlined left-icon'>person_add</span>
                Crear cuenta
              </Link>
            </>
          )}
