  ...
  <footer>
    <div className='container'>
      ...
      <div className='members'>
        ...
        <span>O</span>
        <ButtonLink color='blue-filled' text='Iniciar Seción' url='members/signin' />
      </div>
    </div>
    <div className='newsletter'>
      <p>No te pierdas las últimas novedades y eventos de QRTIXPRO.</p>
      <div className='input-container'>
        <input
          type='email'
          name='email'
          autoComplete='off'
          placeholder='Escribe tú correo electronico'
          required
        />
        <button type='submit'>
